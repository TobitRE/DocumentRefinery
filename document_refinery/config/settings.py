...
Generated by 'django-admin startproject' and maintained for Django 5.2 LTS.
...
DOCLING_ALLOWED_CHUNK_TOKENIZERS = os.environ.get("DOCLING_ALLOWED_CHUNK_TOKENIZERS", "")
